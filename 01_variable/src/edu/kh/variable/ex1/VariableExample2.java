...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 자바 기본 자료형 8가지(참조형 제외 소문자로 작성해야함)
		 * 
		 * 논리형 : boolean (1byte)
		...
		long longNumber = 10000000000L; // L or l
		//The literal 10000000000 of type int is out of range
		//-> 100억 이라는 값은 int의 범위를 벗어남
		//->리터럴값 자체를 int로 인식하고있다.
		//->뒤에 L 을 붙여줌으로써 long 자료형인 것을 나타내줌.
		
		float floatNumber = 1.2345f; // F or f
		//1.2345까지만 쓰면 double 자료형으로 인식하기 떄문에 
		 ...
		 * -> 반대로 생각하면 변수에 애초에 66이라는 수자를 지정하는 것도 가능
		 * 	
		 */
			...
			//1.대소문자 구분, 길이제한x
			int abcddfG123456789; //G 다름
			int abcddfg123456789;
