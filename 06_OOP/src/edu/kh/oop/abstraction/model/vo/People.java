...
//MVC패턴
//Modle - 데이터와 비즈니스 로직(DB,서비스,객체)을 처리하는 부분
//vo(Value Object) : 값 저장용 객체를 만들기 윟나 클래스를 모아두는 개체
//View - 사용자에게 보여지는 화면(UI - HTML,JSP,Thymeleaf,React)
//Controller - 사용자의 요청을 받고, 모델과 뷰를 연결하는 역할(응답)

public class People { //국민(사람) 클래서
	
	//클래스란?? 객체의 특성(속성과 기능)을 정의한것
	// == 객체를 만들기 위한 설계도
