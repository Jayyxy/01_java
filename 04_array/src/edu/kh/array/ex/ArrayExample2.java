...
public class ArrayExample2 {
	...
	public void deepCopy() {
		...
		System.out.println("arr : " + Arrays.toString(arr));
		System.out.println("copyArr1 주소 : " + Arrays.toString(copyArr1));
		...
		System.arraycopy(copyArr1, 0, copyArr2, 0, 0);// 0번 인덱스 부터 시작
